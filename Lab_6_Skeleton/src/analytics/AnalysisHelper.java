...
public class AnalysisHelper {
    ...
    public void getMaxLikeCommentPost(){
        ...
        System.out.println("Q2 - post with most like per comment "+data.getPosts().get(postId).getPostId());
    }
    ...
    public void getPassiveUsers(){
        ...
        for(int i = 0;i< 5;i++){
            System.out.println(users.get(i)+ ",  - Post count: "+ postNumbers.get(
                    users.get(i).getId()
            ));
        }
    ...
    public void getPassiveCommentUsers(){
        ...
        for(int i =0;i<5;i++){
            System.out.println(users.get(i)+ ", - Comment count: " +commentNumbers
                    .get(users.get(i).getId()));
        }
